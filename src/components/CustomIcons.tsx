    ...
    return (
        <SvgIcon>
            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
                <path fill="#161514" fill-rule="evenodd"
...
export function BitbucketIcon() {
    return (
        <SvgIcon>
            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
                <path fill="#2684FF" fill-rule="evenodd"
                      ...
                      clip-rule="evenodd"/>
                <path fill="url(#bitbucket-color-16__paint0_linear_707_135)"
                      d="M14.122 6.033H10.1l-.67 3.931H6.604L3.317 13.86c.105.09.238.139.376.14h8.766a.43.43 0 00.425-.36l1.238-7.607z"/>
                <defs>
                    <linearGradient id="bitbucket-color-16__paint0_linear_707_135" x1="11.544" x2="6.918" y1="4.676"
