            ...
            confirmEmail(token)
                ...
                .catch((error) => {
                    ...
                    if (error.response?.status === 400) {
                        setMessage(error.response.data || "Email has already been confirmed or token has expired.");
                    } else {
        ...
        <Container maxWidth="sm" sx={{textAlign: "center", mt: 8}}>
            ...
            {confirmationStatus === "error" && (
                <>
                    ...
                    <Typography variant="body1" sx={{mb: 4}}>
                        Something went wrong during the confirmation process. Please try again.
                    </Typography>
                    <Button variant="contained" color="primary" onClick={() => router.push("/resend-confirmation")}>
